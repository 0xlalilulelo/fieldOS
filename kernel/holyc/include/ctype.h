#ifndef FIELDOS_HOLYC_INCLUDE_CTYPE_H
#define FIELDOS_HOLYC_INCLUDE_CTYPE_H

/* Freestanding <ctype.h> shim. ASCII-only character classification
 * as static inlines; no locale, no table lookup. The vendored
 * holyc-lang sources only feed ASCII bytes through ctype, so this
 * is sufficient. */
